export const es: Record<string, string> = {
  ...
  "landing.hero.subtitle": "{name} helps the whole team see what to do today. Tasks, projects, people and deadlines — in one place, not scattered across sheets and chat.",
