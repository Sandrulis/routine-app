export const ru: Record<string, string> = {
  ...
  "auth.signup.invite_subtitle":
    "Создайте аккаунт, чтобы присоединиться к команде «{team}».",
  ...
  "errors.auth_turnstile_failed": "Bot check failed. Try again.",  "errors.integrations_save_failed": "Не удалось сохранить настройки интеграции.",
  ...
  "errors.team_invite_account_exists":
    "Для этого e-mail уже есть аккаунт. Войдите, чтобы принять приглашение.",
  "errors.team_invite_email_mismatch":
    "Регистрация возможна только с e-mail из приглашения.",
