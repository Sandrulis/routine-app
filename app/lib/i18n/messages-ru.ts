export const ru: Record<string, string> = {
  ...
  "integrations.turnstile.description": "Bot protection on login, signup, and OAuth flows.",
  "integrations.turnstile.site_key": "Site Key",
  "integrations.turnstile.site_key_hint": "Public key from Cloudflare Turnstile. Shown on login and signup pages.",
  ...
  "integrations.turnstile.hint": "When active, login, signup, password reset, and OAuth require Cloudflare Turnstile verification.",
