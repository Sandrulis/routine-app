export const sv: Record<string, string> = {
  ...
  "landing.faq.plans.answer": "Gratisplanen har ett användartak och färre funktioner. Den betalda planen prissätts per användare och inkluderar tillgängliga moduler. Se jämförelsen under Priser.",
  ...
  "landing.pricing.subtitle": "Gratisplanen har begränsningar. Den betalda planen prissätts per användare, utan användartak.",
