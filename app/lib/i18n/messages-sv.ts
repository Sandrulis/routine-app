export const sv: Record<string, string> = {
  ...
  "errors.team_invite_email_mismatch": "Du måste registrera dig med den inbjudna e-postadressen.",
  ...
  "google_drive.configure_owner_only": "Endast användare med behörigheten «Hantera Google Drive» kan ändra den här integrationen (eller ägaren / systemadmin).",
  ...
  "legal.terms.billing.p11": "Om betalningen misslyckas försöker Stripe debitera igen; vi kan begränsa åtkomst till teamfunktioner för användare som inte är ägare eller saknar faktureringsbehörighet tills saldot är betalt eller prenumerationen återställts. Efter prenumerationens slut eller långvarig utebliven betalning kan åtkomst till betalfunktioner blockeras för alla teamanvändare utom den person som är behörig att hantera fakturering.",
  ...
  "legal.terms.billing.p4": "Varje team har en Stripe-prenumeration. Fakturering sker per användarplats: teamägarens eller teamledarens plats är gratis (1 plats); varje ytterligare aktiv användare kräver en separat betald plats enligt vald plan och faktureringsperiod (månad eller år).",
  "legal.terms.billing.p5": "Teamets prenumerationsavgifter betalas av teamägaren eller annan medlem med behörighet att hantera teaminställningar och fakturering (Team → Prenumerationer). Övriga teamanvändare betalar inte individuellt; deras åtkomst till teamdata och funktioner beror på en aktiv, betald teamprenumeration.",
  ...
  "onedrive.configure_owner_only": "Endast användare med behörigheten «Hantera OneDrive» kan ändra den här integrationen (eller ägaren / systemadmin).",
  ...
  "team.seat.free_owner": "Gratis plats (ägare)",
