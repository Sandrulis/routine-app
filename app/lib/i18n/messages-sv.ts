export const sv: Record<string, string> = {
  ...
  "admin.docs.hint": "Kategorier och underkategorier utgör den publika dokumentationen. Innehållet är tills vidare på standardspråket.",
  "admin.docs.source_language": "Innehållet läggs till på {name} ({code}). Den här texten översätts senare till de övriga språken.",
