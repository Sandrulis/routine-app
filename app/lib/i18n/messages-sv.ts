export const sv: Record<string, string> = {
  ...
  "admin.cron_jobs.page_hint": "Aktivera önskat jobb och kopiera URL:en till cron-job.org. Kör det helst en gång om dagen på morgonen. Medan jobbet är av svarar inte URL:en.",
