export const sv: Record<string, string> = {
  ...
  "landing.seo.description": "{name} is team task management software for small and growing teams. Plan tasks, projects and deadlines in one workspace — without the usual complexity.",
  ...
  "landing.hero.title": "Teamuppgiftshantering utan onödig komplexitet",
  "landing.hero.subtitle": "{name} hjälper hela teamet att se vad som ska göras idag. Uppgifter, projekt, personer och deadlines — på ett ställe, inte utspridda i kalkylark och chatt.",
  "landing.hero.cta_signup": "Prova gratis",
  ...
  "landing.features.team.description": "Invite teammates, assign work and see who is online. No more hunting chat for a file or a promise.",
  "landing.features.team.description_no_files": "Invite teammates, assign work and see who is online. No more hunting chat for a promise.",
  ...
  "landing.features.private_list.description": "Hide a list from the rest of the team. Only you and selected members or roles can see it.",
  ...
  "landing.how.step2.description": "Invite teammates, create lists for projects or clients, and split tasks with due dates.",
  ...
  "landing.faq.invite.answer": "Yes. Invite teammates, assign tasks and see who is online. Everyone works in the same workspace.",
  ...
  "legal.privacy.intro": "This policy explains what personal data we process when you visit routine.app or use the {SYSTEM_NAME} app, why we do it, and what rights you have under the General Data Protection Regulation (EU) 2016/679 (GDPR).",
  "legal.privacy.controller.title": "1. Controller",
  "legal.privacy.controller.p1": "The controller of personal data is the {SYSTEM_NAME} service provider. Write to privacy@routine.app about data processing. We will reply within a reasonable time and may ask for extra details to confirm your identity.",
  ...
  "integrations.google_oauth.redirects.hint": "The first URI is for login/signup, the second for team Google Drive, the third for the Gmail plugin. Also enable the Drive API and Gmail API in Google Cloud.",
  ...
  "errors.team_invite_email_not_configured": "Cannot email a new address without SUPABASE_SERVICE_ROLE_KEY in .env.local. Existing users still receive an in-app notification.",
