export const sv: Record<string, string> = {
  ...
  "team.billing.new_user_prorata_notice": "Om du bjuder in en ny användare utan en betald ledig plats faktureras personen för återstående period till {until} – slutet av teamets abonnemangsperiod. Därefter ingår alla användare på en gemensam teamfaktura.",
  "team.billing.new_user_prorata_notice_no_date": "Om du bjuder in en ny användare utan en betald ledig plats faktureras personen för återstående period till slutet av teamets abonnemangsperiod. Därefter ingår alla användare på en gemensam teamfaktura.",
