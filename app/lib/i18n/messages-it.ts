export const it: Record<string, string> = {
  ...
  "legal.privacy.controller.p1": "Il titolare del trattamento dei dati personali è il fornitore del servizio {SYSTEM_NAME}.{LEGAL_CONTACT} Risponderemo in un tempo ragionevole e potremo chiedere ulteriori dettagli per confermare la tua identità.",
  ...
  "legal.privacy.data.p2": "Team and work data: team name, user names, emails and roles, lists, tasks, subtasks, statuses, due dates, notes, attachment names and content that you or your team enter in the system.",
  ...
  "legal.privacy.intro": "Questa informativa spiega quali dati personali trattiamo quando usi {SYSTEM_NAME}, perché lo facciamo e quali diritti hai ai sensi del Regolamento generale sulla protezione dei dati (UE) 2016/679 (GDPR).",
  ...
  "site_settings.form.legal_email_hint": "Questo indirizzo compare nell'informativa sulla privacy per le richieste sul trattamento dei dati.",
  ...
  "team.billing.new_user_prorata_notice": "Se inviti un nuovo utente senza un posto a pagamento libero, riceverà una fattura per il periodo restante fino al {until} – fine del periodo di abbonamento del team. Dopo, tutti gli utenti sono inclusi in un’unica fattura del team.",
  "team.billing.new_user_prorata_notice_no_date": "Se inviti un nuovo utente senza un posto a pagamento libero, riceverà una fattura per il periodo restante fino alla fine del periodo di abbonamento del team. Dopo, tutti gli utenti sono inclusi in un’unica fattura del team.",
