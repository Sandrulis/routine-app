export const it: Record<string, string> = {
  ...
  "errors.team_invite_email_mismatch": "Devi registrarti con l’e-mail dell’invito.",
  ...
  "google_drive.configure_owner_only": "Solo gli utenti con il permesso «Gestisci Google Drive» possono modificare questa integrazione (o il proprietario / admin di sistema).",
  ...
  "legal.terms.billing.p11": "Se il pagamento fallisce, Stripe riprova l'addebito; possiamo limitare l'accesso alle funzionalità del team per gli utenti che non sono proprietari o non hanno permessi di fatturazione fino a quando il saldo non è saldato o l'abbonamento è ripristinato. Dopo la fine dell'abbonamento o un prolungato mancato pagamento, l'accesso alle funzionalità a pagamento può essere bloccato per tutti gli utenti del team tranne la persona autorizzata a gestire la fatturazione.",
  ...
  "legal.terms.billing.p4": "Ogni team ha un abbonamento Stripe. La fatturazione avviene per posto utente: il posto del proprietario o del manager del team è gratuito (1 posto); ogni utente attivo aggiuntivo richiede un posto a pagamento separato in base al piano e al periodo di fatturazione selezionati (mensile o annuale).",
  "legal.terms.billing.p5": "I costi dell'abbonamento del team sono pagati dal proprietario del team o da un altro membro autorizzato a gestire le impostazioni del team e la fatturazione (Team → Abbonamenti). Gli altri utenti del team non pagano individualmente; il loro accesso ai dati e alle funzionalità del team dipende da un abbonamento di team attivo e pagato.",
  ...
  "onedrive.configure_owner_only": "Solo gli utenti con il permesso «Gestisci OneDrive» possono modificare questa integrazione (o il proprietario / admin di sistema).",
  ...
  "team.seat.free_owner": "Posto gratuito (proprietario)",
