export const it: Record<string, string> = {
  ...
  "admin.cron_jobs.page_hint": "Attiva il job desiderato e copia l’URL in cron-job.org. Meglio eseguirlo una volta al giorno al mattino. Finché è disattivato, l’URL non risponde.",
