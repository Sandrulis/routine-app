export const it: Record<string, string> = {
  ...
  "integrations.google_oauth.redirects.hint": "Il primo URI per ogni origin è per l'accesso/registrazione e il plugin Gmail; il secondo per il Google Drive del team. Aggiungi tutti gli URI in Google Cloud (incluso localhost). Attiva anche Drive API e Gmail API.",
