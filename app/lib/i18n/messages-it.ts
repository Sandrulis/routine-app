export const it: Record<string, string> = {
  ...
  "landing.hero.title": "Gestione delle attività di team senza complessità inutili",
  "landing.hero.subtitle": "{name} aiuta tutto il team a vedere cosa fare oggi. Attività, progetti, persone e scadenze — in un unico posto, non sparsi tra fogli e chat.",
  "landing.hero.cta_signup": "Provalo gratis",
