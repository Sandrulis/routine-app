export const it: Record<string, string> = {
  ...
  "admin.docs.hint": "Categorie e sottocategorie formano la documentazione pubblica. Il contenuto è per ora nella lingua predefinita.",
  "admin.docs.source_language": "Il contenuto viene aggiunto in {name} ({code}). Questo testo verrà poi tradotto nelle altre lingue.",
