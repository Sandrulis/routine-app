export const it: Record<string, string> = {
  ...
  "integrations.resend.hint": "When the integration is active, the system can send transactional email through the Resend API.",
  ...
  "team.invite.resent_no_email": "Email was not sent (Supabase rate limit). Share the invite link manually.",
