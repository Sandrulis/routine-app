...
export const messages: { lv: Record<string, string>; en: Record<string, string> } = {
  lv: {
    ...
    "legal.cookies.preferences.p1": "Preferenču sīkdatnes atceras saskarnes izvēles, piemēram, saraksta logu (Uzdevumi, Faili, Saraksts) kārtību (routine-app-list-window-order) un vēstures bloka redzamību (routine-app-history-pane).",
    ...
    "cookie_consent.category.preferences.description": "Atceras tavas izvēles saskarnē, piemēram, saraksta logu kārtību un vēstures bloka redzamību.",
  ...
  en: {
    ...
    "legal.cookies.preferences.p1": "Preference cookies remember interface choices, such as list window order (Tasks, Files, Overview) (routine-app-list-window-order) and history pane visibility (routine-app-history-pane).",
    ...
    "cookie_consent.category.preferences.description": "Remember your interface choices, such as list window order and history pane visibility.",
