...
export const messages: Record<LanguageCode, Record<string, string>> = {
  lv: {
    ...
    "templates.detail.subtitle":
      "Definē uzdevumu sarakstus un to apakšuzdevumus. Pēc tam šablonu var pievienot mapē.",
    "templates.items.title": "Uzdevumu saraksti",
    "templates.items.help":
      "Katrs saraksts pēc pievienošanas mapē kļūst par uzdevumu ar apakšuzdevumiem.",
  ...
  en: {
    ...
    "templates.detail.subtitle":
      "Define task lists and their subtasks. Then add the template into a folder.",
    "templates.items.title": "Task lists",
    "templates.items.help":
      "Each list becomes a task with subtasks when added into a folder.",
