...
export const messages: { lv: Record<string, string>; en: Record<string, string> } = {
  lv: {
    ...
    "landing.seo.og_tagline": "Komandas uzdevumi vienā darbvietā",
    ...
    "landing.features.todo.description": "Personīga sleja labajā malā. Pieraksti darāmo, atķeksē, un pabeigtais paliek arhīvā ar datumu.",
    ...
    "auth.signup.confirm_modal.title": "Reģistrācija izdevās",
    "auth.signup.confirm_modal.description": "Konts ir izveidots. Atlicis apstiprināt e-pastu.",
    "auth.signup.confirm_modal.body": "Uz {email} nosūtīts apstiprinājuma e-pasts. Atver to un apstiprini adresi, lai varētu ienākt un lietot sistēmu.",
    "auth.signup.confirm_modal.redirect_in": "Pāriešana uz sākumu pēc {seconds} s.",
    ...
    "legal.privacy.meta_description": "{SYSTEM_NAME}: kā apstrādājam personas datus, komandas saturu un integrācijas. Tavas VDAR tiesības un saziņa ar datu pārzini.",
    ...
    "legal.privacy.data.p1": "Konta dati: vārds, uzvārds, e-pasta adrese, parole (glabājam tikai jaucējkodu), valodas izvēle, laika josla, datuma/laika attēlošanas preferences, MFA iestatījumi, paziņojumu preferences un tabulas saskarnes izvēles (kolonnu redzamība, statusu grupu kārtošana).",
    ...
    "legal.privacy.retention.p2": "Ja pieslēdzies atkārtoti deaktivizācijas periodā, konts automātiski tiek atjaunots. Komandas vadītāja konta dzēšana var ietekmēt komandas datus saskaņā ar konta dzēšanas plūsmu.",
    ...
    "legal.terms.meta_description": "{SYSTEM_NAME} lietošanas noteikumi: konts, komandas dati, maksājumi, pieļaujamā lietošana, atbildība un piemērojamie tiesību akti.",
    ...
    "legal.cookies.meta_description": "Kādas sīkdatnes {SYSTEM_NAME} izmanto, kuras ir obligātas, kā darbojas statistika un kā mainīt piekrišanu.",
    ...
    "legal.cookies.preferences.p1": "Preferenču sīkdatnes atceras saskarnes izvēles, piemēram, saraksta logu (Uzdevumi, Faili, Saraksts) kārtību (routine-app-list-window-order), vēstures bloka redzamību (routine-app-history-pane) un statusu grupu sakļaušanu (routine-app-status-group-collapsed).",
    ...
    "cookie_consent.category.preferences.description": "Atceras tavas izvēles saskarnē, piemēram, saraksta logu kārtību, vēstures bloka redzamību un statusu grupu sakļaušanu.",
    ...
    "feedback.general.rating": "Vērtējums",
    "feedback.general.rating_star": "{count} no 5",
    ...
    "feedback.email.subject.feedback": "Atsauksme: {rating}/5",
    ...
    "docs.seo.description": "{name} palīdzības centrs: sāc darbu, komandas iestatījumi, integrācijas un biežākie jautājumi.",
    "docs.seo.article_description": "{title} — {name} dokumentācijas raksts.",
    ...
    "integrations.google_oauth.description": "Konfigurē Google pieslēgšanos login un reģistrācijas lapā, kā arī komandas Google Drive.",
    ...
    "integrations.google_oauth.redirects.hint": "Pirmais URI katrā originā ir login/signup, otrais — komandas Google Drive. Pievieno visus URI Google Cloud (arī localhost). Google Cloud projektā ieslēdz Drive API. Gmail spraudnim izmanto Google Plugin integrāciju.",
    ...
    "integrations.google_plugin.description": "Atsevišķa Google Cloud lietotne Gmail Chrome spraudnim (gmail.addons.current.message.readonly).",
    "integrations.google_plugin.aria.enabled": "Google Plugin integrācija ieslēgta",
    "integrations.google_plugin.reset.confirm_title": "Notīrīt Google Plugin konfigurāciju?",
    "integrations.google_plugin.reset.confirm_description": "Integrācija tiks izslēgta un Gmail spraudnis vairs nevarēs lasīt e-pastus.",
    "integrations.google_plugin.redirects.hint": "Jauns Google Cloud projekts tikai spraudnim. Ieslēdz Gmail API. Consent screen pievieno gmail.addons.current.message.readonly (ne gmail.readonly). OAuth klienta veids: Web application. Authorized JavaScript origins: tasqin.com, www.tasqin.com un localhost:3120. Pēc Client ID maiņas lietotājiem jāatjauno Gmail savienojums.",
    "integrations.google_plugin.scopes.title": "OAuth scopes",
    "integrations.google_plugin.feedback.configured": "Google Plugin integrācija konfigurēta.",
    "integrations.google_plugin.feedback.credentials_saved": "Google Plugin dati saglabāti.",
    "integrations.google_plugin.feedback.reset": "Google Plugin konfigurācija notīrīta.",
    ...
    "errors.integrations_google_plugin_configure_failed": "Neizdevās pabeigt Google Plugin konfigurāciju.",
    ...
    "frontend_modules.label.module_timetracking": "Laika uzskaite",
    "frontend_modules.label.module_factory": "Rūpnīca",
    "factory.menu_description": "Rūpnīcas lietotāji, par kuriem nav jāmaksā atsevišķi",
    "factory.page.subtitle": "Pievieno rūpnīcas lietotājus. Par viņiem nav jāmaksā kā par komandas vietām.",
    "factory.empty": "Vēl nav rūpnīcas lietotāju.",
    "factory.form.title": "Jauns rūpnīcas lietotājs",
    "factory.form.description": "Norādi vārdu, uzvārdu, e-pastu un paroli. Ielogošanās būs pieejama vēlāk.",
    "factory.added": "Rūpnīcas lietotājs pievienots.",
    "factory.removed": "Rūpnīcas lietotājs noņemts.",
    "factory.delete.title": "Noņemt rūpnīcas lietotāju?",
    "factory.delete.description": "{name} vairs nebūs rūpnīcas lietotāju sarakstā.",
    "factory.portal.subtitle": "Ielogojies ar rūpnīcas lietotāja e-pastu un paroli.",
    "factory.portal.unavailable": "Rūpnīcas modulis ir izslēgts.",
    "factory.portal.welcome": "Sveiki, {name}",
    "factory.portal.logout": "Izlogoties",
    "factory.share.label": "Rādīt rūpnīcas darbiniekiem",
    "factory.portal.empty": "Nav koplietotu apakšuzdevumu.",
    "factory.portal.checklists_empty": "Šim apakšuzdevumam nav kontrolsarakstu.",
    "errors.factory_login_invalid": "E-pasts vai parole nav pareiza.",
    "errors.factory_forbidden": "Nav tiesību pārvaldīt rūpnīcas lietotājus.",
    "errors.factory_module_disabled": "Rūpnīcas modulis ir izslēgts.",
    "errors.factory_not_paid": "Rūpnīca ir pieejama tikai maksājošai komandai.",
    "errors.factory_email_taken": "Šāds e-pasts jau ir rūpnīcas lietotājiem.",
    "errors.factory_email_invalid": "Ievadi derīgu e-pastu.",
    "errors.factory_name_required": "Ievadi vārdu un uzvārdu.",
    "errors.factory_save_failed": "Neizdevās saglabāt rūpnīcas lietotāju.",
    "errors.factory_delete_failed": "Neizdevās noņemt rūpnīcas lietotāju.",
    "frontend_modules.aria.enabled": "{key} ieslēgts",
    "frontend_modules.gmail_plugin.toggle_locked": "Vispirms konfigurē un ieslēdz Google Plugin integrāciju (Administrācija → Integrācijas).",
    ...
    "admin.users.empty_filter": "Nav lietotāju ar šo sākumu.",
    "admin.alphabet.label": "Filtrēt pēc sākuma burta",
    "admin.alphabet.digits": "Cipari",
    ...
    "admin.users.last_ip": "Pēdējā IP adrese",
    "admin.users.last_seen": "Pēdējoreiz ienāca",
    "admin.users.last_seen_never": "Vēl nav ienācis",
    "admin.users.email_unconfirmed": "E-pasts nav apstiprināts",
    "admin.users.no_team": "Nav komandā",
    "admin.users.todos.total": "{count} kopā",
    "admin.teams.empty": "Nav nevienas komandas.",
    "admin.teams.empty_filter": "Nav komandu ar šo sākumu.",
    ...
    "admin.teams.stats.completed": "{count} izpildīti",
    ...
    "site_settings.form.notification_favicon": "Paziņojumu favicon",
    "site_settings.form.notification_favicon_hint": "ICO, PNG vai SVG līdz 1.5 MB. Pārlūka cilnē rādās, kad ir nelasīti paziņojumi. Ja nav augšupielādēts, cilnes ikona nemainās.",
    ...
    "team.roles.owner_only": "Lomas var mainīt tikai komandas vadītājs.",
    ...
    "team.duties.title": "Pienākumi",
    "team.duties.description": "Amata birkas (piem. komandas vadītājs, tāmētājs u.c.). Viens cilvēks var būt vairākos pienākumos. Pieejas joprojām nosaka loma.",
    "team.duties.empty": "Nav neviena pienākuma.",
    "team.duties.new_placeholder": "Jauna pienākuma nosaukums",
    "team.duties.feedback.created": "Pienākums pievienots.",
    "team.duties.feedback.deleted": "Pienākums dzēsts.",
    "team.duties.delete.title": "Dzēst pienākumu?",
    "team.duties.delete.description": "Pienākums “{name}” tiks dzēsts un noņemts no lietotājiem.",
    "lists.access.duties_hint": "Katram pienākumam norādi, ko tā lietotāji drīkst darīt šajā sarakstā.",
    "errors.duty_create_failed": "Neizdevās pievienot pienākumu.",
    "errors.duty_reorder_failed": "Neizdevās mainīt pienākumu secību.",
    ...
    "team.access.owner_locked": "Vadītāja lomai ir pilna pieeja, un to nevar mainīt.",
    "team.access.owner_only": "Lomu pieejas var mainīt tikai komandas vadītājs.",
    ...
    "lists.statuses.menu.rename": "Pārsaukt",
    "lists.statuses.menu.change_color": "Mainīt krāsu",
    "lists.statuses.menu.change_icon": "Mainīt ikonu",
    "lists.statuses.icon.title": "Statusa ikona",
    "lists.statuses.icon.description": "Izvēlies ikonu, kas tiks rādīta statusa aplī.",
    "lists.statuses.icon.default": "Nokl.",
    ...
    "lists.sync_statuses.description": "Pievieno šablonā trūkstošos statusus un sakārto tos kā šablonā, ieskaitot paslēptos.",
    ...
    "dashboard.my_tasks.snoozed_only": "Visi tavi uzdevumi ir atlikti uz vēlāku laiku.",
    "dashboard.snooze": "Atlikt",
    "dashboard.snooze.hour": "1 stunda",
    "dashboard.snooze.until_tomorrow": "Līdz rītdienai",
    "dashboard.snooze.week": "1 nedēļa",
    "dashboard.snooze.pick_date": "Izvēlēties datumu",
    "dashboard.snooze.failed": "Neizdevās atlikt uzdevumu.",
    "dashboard.snoozed": "Atliktie",
    "dashboard.snooze.show_again": "Rādīt atkal",
    "dashboard.snooze.show_again.failed": "Neizdevās atkal parādīt uzdevumu.",
    ...
    "google_drive.configure_owner_only": "Integrāciju var mainīt tikai ar pieeju «Pārvaldīt Google Drive» (vai vadītājs / sistēmas admin).",
    ...
    "google_drive.folder.hint": "Piemēram {name} vai Komanda/Faili. Mape tiek izveidota, ja tās vēl nav.",
    ...
    "onedrive.configure_owner_only": "Integrāciju var mainīt tikai ar pieeju «Pārvaldīt OneDrive» (vai vadītājs / sistēmas admin).",
    ...
    "onedrive.folder.hint": "Piemēram {name} vai Komanda/Faili. Mape tiek izveidota, ja tās vēl nav.",
    ...
    "folders.sync_statuses": "Atjaunot statusus",
    "folders.sync_statuses.description": "Pievieno šablonā trūkstošos statusus un sakārto tos kā šablonā, ieskaitot paslēptos.",
    "folders.sync_statuses.success": "Statusi saglabāti.",
    ...
    "lists.windows.history": "Vēsture",
    "lists.windows.history.hide": "Paslēpt vēsturi",
    "lists.windows.history.show": "Rādīt vēsturi",
    ...
    "files.detail.download_to_open": "Lejupielādē failu, lai to atvērtu.",
    ...
    "files.download.started": "Fails tiek lejupielādēts.",
    ...
    "status.group.done": "Pabeigts",
    "status.group.closed": "Slēgts",
    "status.search.empty": "Nav atbilstošu statusu.",
    "status.sort.label": "Statusi",
    "status.sort.asc": "Augošā secībā",
    "status.sort.desc": "Dilstošā secībā",
    "subtasks.columns": "Kolonnas",
    "subtasks.columns.shown": "Redzamās",
    "subtasks.columns.add": "Pievienot kolonnu",
    "subtasks.columns.name_placeholder": "Kolonnas nosaukums",
    "subtasks.columns.reorder": "Mainīt kolonnu secību",
    "subtasks.columns.delete.title": "Dzēst kolonnu?",
    "subtasks.columns.delete.description": "Kolonna “{name}” un tās vērtības uzdevumos tiks dzēstas.",
    ...
    "subtasks.modal.details": "Detaļas",
    ...
    "subtasks.checklist.time.title": "Laika uzskaite",
    "subtasks.checklist.time.start": "Sākt",
    "subtasks.checklist.time.pause": "Pauzēt",
    "subtasks.checklist.time.paused": "Pauzēts",
    "subtasks.checklist.time.stop": "Apturēt",
    "subtasks.checklist.time.started": "Uzsāka",
    "subtasks.checklist.time.ended": "Beidza",
    "subtasks.checklist.time.spent": "Kopā",
    "subtasks.checklist.time.who": "Kurš",
    "subtasks.checklist.filter.show_done": "Rādīt pabeigtos",
    "subtasks.checklist.filter.hide_done": "Paslēpt pabeigtos",
    "subtasks.checklist.filter.show_done_count": "Rādīt {count} pabeigtos",
    ...
    "user_todo.title": "Darāmo saraksts",
    "user_todo.open_with_count": "Darāmo saraksts ({count})",
    "user_todo.placeholder": "Jauns uzdevums",
    "user_todo.empty": "Nav darāmo uzdevumu.",
    "user_todo.archive": "Arhīvs",
    "user_todo.archive_empty": "Nav pabeigtu uzdevumu.",
    "user_todo.completed_on": "Pabeigts {date}",
    ...
    "dashboard.empty.title": "Sāc ar sarakstu",
    "dashboard.empty.description": "Komandā vēl nav sarakstu. Pievieno sarakstu, tad uzdevumu un apakšuzdevumu.",
    "dashboard.empty.task_title": "Sāc ar uzdevumu",
    "dashboard.empty.task_description": "Saraksts ir gatavs. Pievieno uzdevumu un pēc tam apakšuzdevumu.",
    ...
    "email.notification.digest_title": "{count} paziņojumi",
    ...
    "tour.toggle.title": "Izvērst un sakļaut",
    "tour.lists_toggle.text": "Bultiņa izver visus tavus sarakstus tepat sānjoslā, neatverot atsevišķu lapu.",
    "tour.team_toggle.text": "Tā pati bultiņa uz komandas rindas parāda vai paslēpj komandas lietotāju sarakstu.",
    "tour.options_hint": "Zem šīs pogas:",
    "tour.list_item_add.text": "Plusa poga uz saraksta atver izvēlni ar visu, ko sarakstā var pievienot.",
    "tour.list_more.title": "Saraksta darbības",
    "tour.list_more.text": "Trīs punktu poga blakus plusam atver saraksta iestatījumus.",
    "tour.task_more.title": "Uzdevuma darbības",
    "tour.task_more.text": "Tā pati trīs punktu poga uz uzdevuma piedāvā citas darbības.",
    "tour.team_more.title": "Komandas iestatījumi",
    "tour.team_more.text": "Zem trīs punktiem ir komandas pārvaldība un mākoņa integrācijas.",
    "tour.option.edit_hint": "Maini nosaukumu, aprakstu un iestatījumus.",
    "tour.option.archive_hint": "Paslēpj pabeigto, saglabājot vēsturi.",
    "tour.option.delete_hint": "Neatgriezeniski noņem ierakstu.",
    "tour.option.list_name_hint": "Piemēram, projekts, klients vai joma.",
    "tour.option.list_icon_hint": "Ikona un krāsa, lai sarakstu ātri atpazītu.",
    "tour.option.list_private_hint": "Privātu sarakstu redzi tikai tu.",
    "tour.option.subtask_status_hint": "Darāms, procesā, gatavs un citi saraksta statusi.",
    "tour.option.subtask_details_hint": "Apraksts, termiņš, atbildīgais, kontrolsaraksts un pielikumi.",
    "tour.option.subtask_history_hint": "Kas un kad ko mainīja šajā apakšuzdevumā.",
    "tour.step_counter": "{current} no {total}",
    "tour.actions.skip": "Izlaist",
    "tour.actions.back": "Atpakaļ",
    "tour.actions.next": "Tālāk",
    "tour.actions.finish": "Pabeigt",
    "tour.aria.label": "Sistēmas pamācība",
    "tour.welcome.title": "Iepazīsti {SYSTEM_NAME}",
    "tour.welcome.text": "Izejam cauri sānjoslai un parādām, ko dara katra poga un kādas opcijas slēpjas zem tās. Vari pārtraukt jebkurā brīdī.",
    "tour.home.title": "Sākums",
    "tour.home.text": "Šeit redzi savu dienas kopsavilkumu: tuvākos termiņus un uzdevumus, kas gaida tavu darbu.",
    "tour.lists.title": "Saraksti",
    "tour.lists.text": "Saraksti ir vieta, kur glabājas viss darbs. Uzbraucot ar peli, rindas labajā malā parādās vairākas pogas.",
    "tour.lists_add.title": "Jauns saraksts",
    "tour.lists_add.text": "Plusa poga parādās, kad ar peli pārvieto pār rindu, un atver jauna saraksta formu.",
    "tour.list_item.title": "Tavs saraksts",
    "tour.list_item.text": "Atver sarakstu, lai redzētu visus tā uzdevumus. Ar bultiņu izver saturu tepat sānjoslā.",
    "tour.task.title": "Uzdevums",
    "tour.task.text": "Uzdevums ir viens darāmais. Tam var pievienot aprakstu, termiņu, atbildīgo un failus.",
    "tour.task_add.title": "Jauns apakšuzdevums",
    "tour.task_add.text": "Šī poga sadala uzdevumu mazākos soļos. Katram apakšuzdevumam ir savs statuss un izpildītājs.",
    "tour.subtask.title": "Apakšuzdevums",
    "tour.subtask.text": "Klikšķini uz krāsainā apļa, lai ātri nomainītu statusu, vai uz nosaukuma, lai atvērtu detaļas.",
    "tour.team.title": "Komanda",
    "tour.team.text": "Šeit redzi komandas lietotājus un to, kurš ir tiešsaistē. Arī šai rindai labajā malā ir vairākas pogas.",
    "tour.team_add.title": "Uzaicini lietotāju",
    "tour.team_add.text": "Nosūti uzaicinājumu uz e-pastu. Lietotājs pievienojas komandai un uzreiz redz kopīgos sarakstus.",
    "tour.user_menu.title": "Tavs profils",
    "tour.user_menu.text": "Zem sava vārda atrodi uzstādījumus, paziņojumus un pogu, ar ko šo pamācību palaist vēlreiz.",
    "tour.finish.title": "Viss gatavs",
    "tour.finish.text": "Sāc ar pirmo sarakstu. Ja gribēsi atkārtot pamācību, atradīsi to izvēlnē zem sava vārda.",
    "user_menu.tour": "Sistēmas pamācība",
    "user_menu.tour_hint": "Iziet ievadu vēlreiz",
    ...
    "user_menu.password.set": "Pievienot paroli",
    "user_menu.password.set_hint": "Iestatīt paroli ienākšanai ar e-pastu",
    "user_menu.password.set_description": "Izvēlies paroli, lai varētu ienākt arī ar e-pastu un paroli.",
    "user_menu.password.set_saved": "Parole pievienota. Tagad vari ienākt ar e-pastu un paroli.",
    ...
    "errors.team_owner_failed": "Neizdevās pievienot komandas vadītāju.",
    ...
    "errors.auth_email_not_confirmed": "Apstiprini e-pastu, pirms ienāc sistēmā.",
    ...
    "errors.extension_gmail_forbidden": "Gmail pieeja liegta. Consent screen pievieno gmail.addons.current.message.readonly un atkārtoti Savienot Gmail.",
    ...
    "extension.gmail.options.hint": "Ielogojies {SYSTEM_NAME} tajā pašā Chrome profilā. Pielikumi nāk no atvērtās Gmail vēstules (līdz 25 MB; lielākiem failiem vajag komandas Google Drive).",
    ...
    "extension.gmail.options.connect_failed": "Neizdevās savienot Gmail. Pārbaudi Google Plugin integrāciju un OAuth scopes.",
    ...
    "extension.gmail.done.error_body": "Mēģini vēlreiz no Gmail spraudņa. Pārliecinies, ka Google Plugin un Gmail API ir ieslēgti.",
    ...
    "errors.team_invite_email_mismatch": "Jāizmanto uzaicinājuma e-pasta adrese.",
    ...
    "errors.team_member_leave_owner": "Komandas vadītājs nevar pamest komandu. Vispirms iecēl jaunu vadītāju.",
    ...
    "errors.frontend_module_google_plugin_required": "Gmail spraudņa moduli var ieslēgt tikai pēc Google Plugin integrācijas konfigurācijas un ieslēgšanas.",
    ...
    "errors.user_todo_save_failed": "Neizdevās saglabāt darāmo.",
    ...
    "errors.feedback_rating_invalid": "Izvēlies vērtējumu no 0 līdz 5 zvaigznēm.",
    ...
    "legal.terms.billing.p4": "Katram komandai ir viens Stripe abonements. Norēķini notiek par lietotāju vietām: komandas vadītāja vieta ir bez maksas (1 vieta); par katru papildu aktīvo lietotāju nepieciešama atsevišķa apmaksāta vieta saskaņā ar izvēlēto plānu un norēķinu periodu (mēnesis vai gads).",
    "legal.terms.billing.p5": "Norēķinus par komandas abonementu veic komandas vadītājs vai cits dalībnieks ar tiesībām pārvaldīt komandas uzstādījumus un norēķinus (sadaļa Komanda → Norēķini). Pārējie komandas lietotāji neapmaksā pakalpojumu individuāli; viņu piekļuve komandas datiem un funkcijām ir atkarīga no aktīva un apmaksāta komandas abonementa.",
    ...
    "legal.terms.billing.p11": "Ja maksājums netiek saņemts, Stripe mēģina to atkārtoti; varam ierobežot piekļuvi komandas funkcijām lietotājiem, kas nav vadītājs vai nav ar norēķinu tiesībām, līdz parāds ir nomaksāts vai abonements atjaunots. Pēc abonementa beigām vai ilgstošas neapmaksas piekļuve maksas funkcijām var tikt bloķēta visiem komandas lietotājiem, izņemot personu ar tiesībām pārvaldīt norēķinus.",
  ...
  en: {
    ...
    "landing.seo.og_tagline": "Team tasks in one workspace",
    ...
    "landing.features.todo.description": "A personal column on the right. Jot down what to do, check it off, and completed items stay in the archive with the date.",
    ...
    "auth.signup.confirm_modal.title": "Registration successful",
    "auth.signup.confirm_modal.description": "Your account is created. Confirm your email next.",
    "auth.signup.confirm_modal.body": "A confirmation email was sent to {email}. Open it and confirm your address so you can sign in and keep using the system.",
    "auth.signup.confirm_modal.redirect_in": "Going to the home page in {seconds} s.",
    ...
    "legal.privacy.meta_description": "{SYSTEM_NAME}: how we process personal data, team content and integrations. Your GDPR rights and how to contact the controller.",
    ...
    "legal.privacy.data.p1": "Account data: first and last name, email address, password (stored only as a hash), language choice, time zone, date/time display preferences, MFA settings, notification preferences and table interface choices (column visibility, status group sorting).",
    ...
    "legal.privacy.retention.p2": "If you sign in again during deactivation, the account is automatically restored. Deleting a team leader’s account may affect team data according to the account deletion flow.",
    ...
    "legal.terms.meta_description": "{SYSTEM_NAME} terms of use: account, team data, billing, acceptable use, liability and applicable law.",
    ...
    "legal.cookies.meta_description": "Which cookies {SYSTEM_NAME} uses, which are required, how analytics works and how to change your consent.",
    ...
    "legal.cookies.preferences.p1": "Preference cookies remember interface choices, such as list window order (Tasks, Files, Overview) (routine-app-list-window-order), history pane visibility (routine-app-history-pane) and collapsed status groups (routine-app-status-group-collapsed).",
    ...
    "cookie_consent.category.preferences.description": "Remember your interface choices, such as list window order, history pane visibility and collapsed status groups.",
    ...
    "feedback.general.rating": "Rating",
    "feedback.general.rating_star": "{count} of 5",
    ...
    "feedback.email.body.feedback": "{name} ({email}) sent {kind}.\n\n{rating}/5\n\n{body}",
    ...
    "docs.seo.description": "{name} help centre: getting started, team settings, integrations and common questions.",
    "docs.seo.article_description": "{title} — {name} documentation article.",
    ...
    "integrations.google_oauth.title": "Google OAuth",
    "integrations.google_oauth.description": "Configure Google sign-in on the login and signup pages, and team Google Drive.",
    "integrations.google_oauth.client_id": "Client ID",
    "integrations.google_oauth.client_secret": "Client Secret",
    "integrations.google_oauth.client_secret_placeholder": "Google OAuth Client Secret",
    ...
    "integrations.google_oauth.redirects.title": "Redirect URI",
    "integrations.google_oauth.redirects.hint": "The first URI for each origin is for login/signup, the second for team Google Drive. Add every URI in Google Cloud (including localhost). Enable the Drive API. Use the Google Plugin integration for Gmail.",
    ...
    "integrations.google_plugin.title": "Google Plugin",
    "integrations.google_plugin.description": "A separate Google Cloud app for the Gmail Chrome plugin (gmail.addons.current.message.readonly).",
    "integrations.google_plugin.aria.enabled": "Google Plugin integration enabled",
    "integrations.google_plugin.reset.confirm_title": "Clear Google Plugin configuration?",
    "integrations.google_plugin.reset.confirm_description": "The integration will be disabled and the Gmail plugin will no longer be able to read emails.",
    "integrations.google_plugin.redirects.hint": "Create a new Google Cloud project for the plugin only. Enable the Gmail API. Add gmail.addons.current.message.readonly on the consent screen (not gmail.readonly). OAuth client type: Web application. Authorized JavaScript origins: tasqin.com, www.tasqin.com and localhost:3120. After changing the Client ID, users must reconnect Gmail.",
    "integrations.google_plugin.scopes.title": "OAuth scopes",
    "integrations.google_plugin.feedback.configured": "Google Plugin integration configured.",
    "integrations.google_plugin.feedback.credentials_saved": "Google Plugin credentials saved.",
    "integrations.google_plugin.feedback.reset": "Google Plugin configuration cleared.",
    "integrations.microsoft_oauth.title": "Microsoft OAuth",
    ...
    "errors.integrations_google_plugin_configure_failed": "Could not complete Google Plugin configuration.",
    ...
    "errors.billing_only_free_seat": "The team leader’s seat is free. Buy a paid seat to invite others.",
    "errors.billing_open_seat_available":
    ...
    "frontend_modules.label.module_timetracking": "Time Tracking",
    "frontend_modules.label.module_factory": "Factory",
    "factory.menu_description": "Factory users, not billed as extra seats",
    "factory.page.subtitle": "Add factory users. They are not billed as team seats.",
    "factory.empty": "No factory users yet.",
    "factory.form.title": "New factory user",
    "factory.form.description": "Enter first name, last name, email and password. Sign-in comes later.",
    "factory.added": "Factory user added.",
    "factory.removed": "Factory user removed.",
    "factory.delete.title": "Remove factory user?",
    "factory.delete.description": "{name} will be removed from the factory user list.",
    "factory.portal.subtitle": "Sign in with a factory user email and password.",
    "factory.portal.unavailable": "The factory module is turned off.",
    "factory.portal.welcome": "Hello, {name}",
    "factory.portal.logout": "Log out",
    "factory.share.label": "Show to factory workers",
    "factory.portal.empty": "No shared subtasks.",
    "factory.portal.checklists_empty": "This subtask has no checklists.",
    "errors.factory_login_invalid": "Email or password is incorrect.",
    "errors.factory_forbidden": "You cannot manage factory users.",
    "errors.factory_module_disabled": "The factory module is turned off.",
    "errors.factory_not_paid": "Factory is available only for a paying team.",
    "errors.factory_email_taken": "This email is already a factory user.",
    "errors.factory_email_invalid": "Enter a valid email.",
    "errors.factory_name_required": "Enter a first and last name.",
    "errors.factory_save_failed": "Could not save the factory user.",
    "errors.factory_delete_failed": "Could not remove the factory user.",
    "frontend_modules.aria.enabled": "{key} enabled",
    "frontend_modules.gmail_plugin.toggle_locked": "First configure and enable the Google Plugin integration (Administration → Integrations).",
    ...
    "admin.users.empty_filter": "No users start with this.",
    "admin.alphabet.label": "Filter by first letter",
    "admin.alphabet.digits": "Numbers",
    ...
    "admin.users.last_ip": "Last IP address",
    "admin.users.last_seen": "Last signed in",
    "admin.users.last_seen_never": "Has not signed in yet",
    "admin.users.email_unconfirmed": "Email is not confirmed",
    "admin.users.no_team": "Not in a team",
    "admin.users.todos.total": "{count} total",
    "admin.teams.empty": "No teams yet.",
    "admin.teams.empty_filter": "No teams start with this.",
    ...
    "admin.teams.stats.completed": "{count} completed",
    ...
    "site_settings.form.notification_favicon": "Notification favicon",
    "site_settings.form.notification_favicon_hint": "ICO, PNG, or SVG up to 1.5 MB. Shown in the browser tab when there are unread notifications. If not uploaded, the tab icon does not change.",
    ...
    "team.billing.free_owner_seat": "The team leader’s seat is free. You pay only for seats above 1.",
    ...
    "team.seat.free_owner": "Free seat (leader)",
    ...
    "team.roles.owner_only": "Only the team leader can change roles.",
    ...
    "team.duties.title": "Duties",
    "team.duties.description": "Job labels (e.g. team lead, estimator, etc.). One person can have several duties. Access is still controlled by the role.",
    "team.duties.empty": "No duties yet.",
    "team.duties.new_placeholder": "New duty name",
    "team.duties.feedback.created": "Duty added.",
    "team.duties.feedback.deleted": "Duty deleted.",
    "team.duties.delete.title": "Delete duty?",
    "team.duties.delete.description": "Duty “{name}” will be deleted and removed from users.",
    "lists.access.duties_hint": "Set what users with each duty may do in this list.",
    "errors.duty_create_failed": "Could not add duty.",
    "errors.duty_reorder_failed": "Could not reorder duties.",
    ...
    "team.access.owner_locked": "The leader role has full access and cannot be changed.",
    "team.access.owner_only": "Only the team leader can change role access.",
    ...
    "lists.statuses.menu.rename": "Rename",
    "lists.statuses.menu.change_color": "Change color",
    "lists.statuses.menu.change_icon": "Change icon",
    "lists.statuses.icon.title": "Status icon",
    "lists.statuses.icon.description": "Choose an icon shown inside the status circle.",
    "lists.statuses.icon.default": "Default",
    ...
    "lists.sync_statuses.description": "Add missing template statuses and match the template order, including hidden statuses.",
    ...
    "dashboard.my_tasks.snoozed_only": "All your tasks are snoozed for later.",
    "dashboard.snooze": "Snooze",
    "dashboard.snooze.hour": "1 hour",
    "dashboard.snooze.until_tomorrow": "Until tomorrow",
    "dashboard.snooze.week": "1 week",
    "dashboard.snooze.pick_date": "Pick a date",
    "dashboard.snooze.failed": "Could not snooze the task.",
    "dashboard.snoozed": "Snoozed",
    "dashboard.snooze.show_again": "Show again",
    "dashboard.snooze.show_again.failed": "Could not show the task again.",
    ...
    "google_drive.configure_owner_only": "Only users with the Manage Google Drive permission can change this integration (or the leader / system admin).",
    ...
    "onedrive.configure_owner_only": "Only users with the Manage OneDrive permission can change this integration (or the leader / system admin).",
    ...
    "folders.sync_statuses": "Refresh statuses",
    "folders.sync_statuses.description": "Add missing template statuses and match the template order, including hidden statuses.",
    "folders.sync_statuses.success": "Statuses saved.",
    ...
    "lists.windows.history": "History",
    "lists.windows.history.hide": "Hide history",
    "lists.windows.history.show": "Show history",
    ...
    "files.detail.download_to_open": "Download the file to open it.",
    ...
    "files.download.started": "Downloading file…",
    ...
    "status.sort.label": "Statuses",
    "status.sort.asc": "Ascending",
    "status.sort.desc": "Descending",
    "subtasks.columns": "Columns",
    "subtasks.columns.shown": "Shown",
    "subtasks.columns.add": "Add column",
    "subtasks.columns.name_placeholder": "Column name",
    "subtasks.columns.reorder": "Reorder columns",
    "subtasks.columns.delete.title": "Delete column?",
    "subtasks.columns.delete.description": "Column “{name}” and its values on tasks will be deleted.",
    ...
    "subtasks.checklist.time.title": "Time Tracking",
    "subtasks.checklist.time.start": "Start",
    "subtasks.checklist.time.pause": "Pause",
    "subtasks.checklist.time.paused": "Paused",
    "subtasks.checklist.time.stop": "Stop",
    "subtasks.checklist.time.started": "Started",
    "subtasks.checklist.time.ended": "Ended",
    "subtasks.checklist.time.spent": "Total",
    "subtasks.checklist.time.who": "Who",
    "subtasks.checklist.filter.show_done": "Show completed",
    "subtasks.checklist.filter.hide_done": "Hide completed",
    "subtasks.checklist.filter.show_done_count": "Show {count} completed",
    ...
    "user_todo.title": "To Do List",
    "user_todo.open_with_count": "To Do List ({count})",
    "user_todo.placeholder": "New to-do",
    "user_todo.empty": "No open to-dos.",
    "user_todo.archive": "Archive",
    "user_todo.archive_empty": "No completed to-dos.",
    "user_todo.completed_on": "Completed {date}",
    ...
    "dashboard.empty.title": "Start with a list",
    "dashboard.empty.description": "This team has no lists yet. Add a list, then a task and a subtask.",
    "dashboard.empty.task_title": "Start with a task",
    "dashboard.empty.task_description": "The list is ready. Add a task and then a subtask.",
    ...
    "tour.toggle.title": "Expand and collapse",
    "tour.lists_toggle.text": "The arrow expands all your lists right here in the sidebar, without opening a separate page.",
    "tour.team_toggle.text": "The same arrow on the team row shows or hides the list of team users.",
    "tour.options_hint": "Under this button:",
    "tour.list_item_add.text": "The plus button on a list opens a menu with everything you can add to it.",
    "tour.list_more.title": "List actions",
    "tour.list_more.text": "The three-dot button next to the plus opens the list settings.",
    "tour.task_more.title": "Task actions",
    "tour.task_more.text": "The same three-dot button on a task offers a different set of actions.",
    "tour.team_more.title": "Team settings",
    "tour.team_more.text": "The three dots hold team management and cloud integrations.",
    "tour.option.edit_hint": "Change the name, description and settings.",
    "tour.option.archive_hint": "Hides finished work but keeps the history.",
    "tour.option.delete_hint": "Removes the item for good.",
    "tour.option.list_name_hint": "For example a project, a client or an area.",
    "tour.option.list_icon_hint": "An icon and colour so the list is easy to spot.",
    "tour.option.list_private_hint": "A private list is visible only to you.",
    "tour.option.subtask_status_hint": "To do, in progress, done and any other status of the list.",
    "tour.option.subtask_details_hint": "Description, due date, assignee, checklist and attachments.",
    "tour.option.subtask_history_hint": "Who changed what in this subtask, and when.",
    "tour.step_counter": "{current} of {total}",
    "tour.actions.skip": "Skip",
    "tour.actions.back": "Back",
    "tour.actions.next": "Next",
    "tour.actions.finish": "Finish",
    "tour.aria.label": "Product tour",
    "tour.welcome.title": "Get to know {SYSTEM_NAME}",
    "tour.welcome.text": "We will walk through the sidebar and show what every button does and which options hide under it. You can stop at any time.",
    "tour.home.title": "Home",
    "tour.home.text": "Your daily overview: upcoming deadlines and the tasks waiting for you.",
    "tour.lists.title": "Lists",
    "tour.lists.text": "Lists hold all your work. Hover over the row and several buttons appear on its right side.",
    "tour.lists_add.title": "New list",
    "tour.lists_add.text": "The plus button appears when you hover over the row and opens the new list form.",
    "tour.list_item.title": "Your list",
    "tour.list_item.text": "Open a list to see all its tasks, or use the arrow to expand it right here in the sidebar.",
    "tour.task.title": "Task",
    "tour.task.text": "A task is one piece of work. Add a description, a due date, an assignee and files.",
    "tour.task_add.title": "New subtask",
    "tour.task_add.text": "This button splits a task into smaller steps. Every subtask has its own status and owner.",
    "tour.subtask.title": "Subtask",
    "tour.subtask.text": "Click the coloured dot to change the status quickly, or the name to open the details.",
    "tour.team.title": "Team",
    "tour.team.text": "See your team users and who is online. This row also has several buttons on its right side.",
    "tour.team_add.title": "Invite a user",
    "tour.team_add.text": "Send an invite by email. The user joins the team and immediately sees the shared lists.",
    "tour.user_menu.title": "Your profile",
    "tour.user_menu.text": "Under your name you will find settings, notifications and the button to run this tour again.",
    "tour.finish.title": "All set",
    "tour.finish.text": "Start with your first list. To repeat the tour, open the menu under your name.",
    "user_menu.tour": "Product tour",
    "user_menu.tour_hint": "Run the intro again",
    ...
    "user_menu.password.set": "Add password",
    "user_menu.password.set_hint": "Set a password for email sign-in",
    "user_menu.password.set_description": "Choose a password so you can also sign in with email and password.",
    "user_menu.password.set_saved": "Password added. You can now sign in with email and password.",
    ...
    "errors.team_owner_failed": "Could not add the team leader.",
    ...
    "errors.auth_email_not_confirmed": "Confirm your email before signing in.",
    ...
    "errors.extension_gmail_fetch_failed": "Could not load the email from the open Gmail message.",
    "errors.extension_gmail_message_id": "Could not find the Gmail message ID.",
    "errors.extension_gmail_forbidden": "Gmail access denied. Add gmail.addons.current.message.readonly on the consent screen and reconnect Gmail.",
    ...
    "extension.gmail.loading_gmail": "Loading email and attachments from the open Gmail message…",
    "extension.gmail.progress_email": "Loading the email from the open Gmail message…",
    ...
    "extension.gmail.result.closing_in": "Closes in {seconds} s.",
    ...
    "extension.gmail.options.hint": "Sign in to {SYSTEM_NAME} in the same Chrome profile. Attachments come from the open Gmail message (up to 25 MB; larger files need team Google Drive).",
    ...
    "extension.gmail.options.connect_failed": "Could not connect Gmail. Check the Google Plugin integration and OAuth scopes.",
    ...
    "extension.gmail.done.error_body": "Try again from the Gmail plugin. Make sure Google Plugin and the Gmail API are enabled.",
    ...
    "errors.team_invite_email_mismatch": "You must use the invited email address.",
    ...
    "errors.team_member_leave_owner": "Team leaders cannot leave. Appoint a new leader first.",
    ...
    "errors.frontend_module_google_plugin_required": "Enable the Gmail plugin module only after the Google Plugin integration is configured and turned on.",
    ...
    "errors.user_todo_save_failed": "Could not save the to-do.",
    ...
    "errors.feedback_rating_invalid": "Choose a rating from 0 to 5 stars.",
    ...
    "legal.terms.billing.p4": "Each team has one Stripe subscription. Billing is per user seat: the team leader seat is free (1 seat); each additional active user requires a separate paid seat according to the selected plan and billing period (monthly or yearly).",
    "legal.terms.billing.p5": "Team subscription charges are paid by the team leader or another member with permission to manage team settings and billing (Team → Billing). Other team users do not pay individually; their access to team data and features depends on an active, paid team subscription.",
    ...
    "legal.terms.billing.p11": "If payment fails, Stripe retries the charge; we may restrict access to team features for users who are not the leader or do not have billing permissions until the balance is settled or the subscription is restored. After subscription end or prolonged non-payment, access to paid features may be blocked for all team users except the person authorised to manage billing.",
