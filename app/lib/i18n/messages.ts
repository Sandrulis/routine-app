...
export const messages: { lv: Record<string, string>; en: Record<string, string> } = {
  lv: {
    ...
    "legal.cookies.preferences.p1": "Preferenču sīkdatnes atceras saskarnes izvēles, piemēram, saraksta logu (Uzdevumi, Faili, Saraksts) kārtību (routine-app-list-window-order), vēstures bloka redzamību (routine-app-history-pane), statusu kārtošanu (routine-app-status-group-sort) un tabulas kolonnu redzamību (routine-app-table-columns).",
    ...
    "cookie_consent.category.preferences.description": "Atceras tavas izvēles saskarnē, piemēram, saraksta logu kārtību, vēstures bloka redzamību, statusu kārtošanu un tabulas kolonnu redzamību.",
  ...
  en: {
    ...
    "legal.cookies.preferences.p1": "Preference cookies remember interface choices, such as list window order (Tasks, Files, Overview) (routine-app-list-window-order), history pane visibility (routine-app-history-pane), status sorting (routine-app-status-group-sort) and table column visibility (routine-app-table-columns).",
    ...
    "cookie_consent.category.preferences.description": "Remember your interface choices, such as list window order, history pane visibility, status sorting and table column visibility.",
