...
export const messages: { lv: Record<string, string>; en: Record<string, string> } = {
  lv: {
    ...
    "lists.sync_statuses.description": "Pievieno šablonā trūkstošos statusus visām saraksta mapēm, kurām tie trūkst.",
    ...
    "folders.sync_statuses.description": "Pievieno šablonā trūkstošos statusus šīs mapes uzdevumiem.",
  ...
  en: {
    ...
    "lists.sync_statuses.description": "Add missing template statuses to every folder in this list that does not have them.",
    ...
    "folders.sync_statuses.description": "Add missing template statuses to tasks in this folder.",
