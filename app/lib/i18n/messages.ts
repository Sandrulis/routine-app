...
export const messages: { lv: Record<string, string>; en: Record<string, string> } = {
  lv: {
    ...
    "admin.docs.hint": "Kategorijas un apakškategorijas veido publisko dokumentāciju. Saturs pagaidām ir noklusējuma valodā.",
    "admin.docs.source_language": "Saturs tiek pievienots valodā {name} ({code}). Vēlāk šis teksts tiks tulkots pārējās valodās.",
  ...
  en: {
    ...
    "admin.docs.hint": "Categories and subcategories make up the public documentation. Content is currently in the default language.",
    "admin.docs.source_language": "Content is added in {name} ({code}). This text will later be translated into the other languages.",
