...
export const messages: { lv: Record<string, string>; en: Record<string, string> } = {
  lv: {
    ...
    "integrations.google_plugin.description": "Atsevišķa Google Cloud lietotne Gmail Chrome spraudnim (gmail.readonly).",
    ...
    "integrations.google_plugin.redirects.hint": "Jauns Google Cloud projekts tikai spraudnim. Ieslēdz Gmail API. Consent screen pievieno visus scopes. OAuth klienta veids: Web application. Authorized JavaScript origins: tasqin.com, www.tasqin.com un localhost:3120. Pēc Client ID maiņas lietotājiem jāatjauno Gmail savienojums.",
    ...
    "site_payment_plans.form.early_bird_prices": "Early access cenas par vienu lietotāju (EUR)",
    "site_payment_plans.form.early_bird_prices_hint": "Šīs cenas attiecas uz Early access vietām un arī ir par vienu lietotāju. Tukšus periodus vari atstāt tukšus.",
    ...
    "site_payment_plans.early_bird.hint": "Kopīgs limīts Early access vietām (ne komandām). Vieta kļūst Early access pirkuma brīdī, ja poolā vēl ir vietas. Ja lietotāju noņem un līdz cikla beigām vietu neaizpilda, Early access vieta pazūd un neatgriežas poolā. 0 - Early access izslēgts.",
    ...
    "site_payment_plans.early_bird.saved": "Early access limīts saglabāts.",
    ...
    "admin.teams.plan.early_bird_seats": "Early access vietas: {count}",
    ...
    "folders.sync_statuses.success": "Statusi atjaunoti.",
    ...
    "extension.gmail.options.connect_failed": "Neizdevās savienot Gmail. Pārbaudi Google Plugin integrāciju un Gmail API.",
    ...
    "errors.early_bird_limit_reached": "Early access slotu limits ir sasniegts.",
    ...
    "errors.early_bird_limit_invalid": "Ievadi derīgu Early access slotu skaitu (0 vai vairāk).",
    "errors.early_bird_save_failed": "Neizdevās saglabāt Early access limītu.",
  ...
  en: {
    ...
    "integrations.google_plugin.title": "Google Plugin",
    "integrations.google_plugin.description": "A separate Google Cloud app for the Gmail Chrome plugin (gmail.readonly).",
    ...
    "site_payment_plans.form.early_bird_prices": "Early access prices per user (EUR)",
    "site_payment_plans.form.early_bird_prices_hint": "These prices apply to Early access seats and are also per user. You can leave unused periods empty.",
    ...
    "site_payment_plans.early_bird.section": "Early access",
    "site_payment_plans.early_bird.hint": "Global limit of Early access seats (not teams). A purchased seat is Early access if seats remain in the pool. If a user is removed and the seat is not filled before the cycle ends, that Early access seat is lost and does not return to the pool. 0 disables Early access.",
    ...
    "admin.teams.plan.early_bird": "Early access",
    "admin.teams.plan.early_bird_seats": "Early access seats: {count}",
    ...
    "folders.sync_statuses.success": "Statuses refreshed.",
    ...
    "extension.gmail.options.connect_failed": "Could not connect Gmail. Check the Google Plugin integration and the Gmail API.",
    ...
    "errors.early_bird_limit_reached": "Early access slot limit has been reached.",
    ...
    "legal.terms.billing.p10": "If the system administrator enables a trial period, new teams may receive a specific plan for a limited number of days; during an active trial, inviting new users usually does not require a separate paid seat. Early access is a limited global pool of seats at a special price; a seat becomes Early access at purchase time if seats remain in the pool. If a user is removed and the seat is not filled before the cycle ends, Early access status is not returned to the pool.",
