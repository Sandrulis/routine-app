...
- **Komanda** — pieslēgtam lietotājam bez komandas bloķējošs izveides modālis; lomas ar sānjoslas un darbību pieejām; biedri un saraksti kopīgi Postgres; `...` → **Šabloni** (`/templates`) ar mapēm, uzdevumiem un apakšuzdevumiem (DnD); mapes `+` ievieto šablonu kā apakšstruktūru
