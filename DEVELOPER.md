...
```
proxy.ts                          # Sesijas refresh, ielogota novirzīšana, publisko lapu valodas prefiksi (`/en`, `/de`, …); `/lv` → `/`; kanoniskā hosta 301 ar CORS, ja Origin ir `chrome-extension://`; CSP nonce uz request un response (`buildContentSecurityPolicy`)
