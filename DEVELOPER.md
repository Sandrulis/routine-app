...
| `/admin/teams` | Visas `teams`: pievienot, labot, dzēst (kaskāde uz darba datiem); VIP zvaigzne lietotāju modālī (`setAdminTeamVipAction`, `is_vip`) |
