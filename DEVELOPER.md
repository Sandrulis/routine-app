...
Legal teksti: `app/lib/legal/documents.ts` (privātums, noteikumi, sīkdatnes). Datu pārziņa identitāte no `site_settings`: `legal_entity_name`, `legal_entity_reg_no`, `legal_entity_address`, `legal_email` (`115`); tukšs e-pasts izlaiž kontakta teikumu. Politikas sedz apstrādātājus (Supabase, Vercel, Stripe, Google u.c.), integrācijas, konta dzēšanu (30 d.), sīkdatņu inventāru un EEZ pārnesumus. UI: `LegalDocumentView` ar **Saturs** sānjoslu.
