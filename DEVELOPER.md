...
| `module_todo` | Labajā malā personīga **Darāmo saraksts** sleja (`user_todos`); atķeksētais pazūd no saraksta (done + `completed_at`); arhīva poga rāda pabeigtos ar datumu; X paslēpj sleju, ikona ceļa joslā atver atpakaļ (badge ar atvērto skaitu, ja sleja nav redzama) | Sleja un landing kartīte nav |
