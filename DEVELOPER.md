...
| Rinda | Saturs |
|---|---|
| Sākums | `/dashboard` `DashboardHomePage` — live meklēšana visiem uzdevumiem/apakšuzdevumiem (arī arhīvā); Mani uzdevumi (tikai ja ir piesaistīti) un darbs pa sarakstiem; bez komandas — tukšs stāvoklis + jaunas komandas poga |
...
| Klikšķis | Lapa | UI |
|---|---|---|
| Sākums | `/dashboard` | `DashboardHomePage` — live meklēšana (`DashboardTaskSearch`) visiem uzdevumiem/apakšuzdevumiem (arī arhivā, arhivētie blāvi); Mani uzdevumi tikai tad, ja ir piesaistīti (bez slēgtiem); tad atdalītājs un sarakstu kopsavilkums; grupēšana pēc statusa pretēji picker; apakšuzdevuma klikšķis atver modāli |
