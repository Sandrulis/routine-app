...
| `/docs` | Publiskā dokumentācija (`DocsShell` + sānjosla); ieslēdz `/admin/docs`; kājene **Documentation** ja `docs_enabled` |
...
app/
  ...
  (docs)/
    docs/                         # Publiskā dokumentācija (sidebar + raksts); ieslēdz /admin/docs
  ...
  components/
    ...
    docs-shell.tsx                # Publiskais docs layout: tumša sānjosla + raksts
    docs-sidebar.tsx              # Docs kategorijas/apakškategorijas
